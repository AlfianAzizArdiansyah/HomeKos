            ...
            <div class="overflow-x-auto rounded-lg shadow">
                <table class="w-full border-collapse bg-white text-gray-800 text-md text-center">
                    ...
                    <tbody>
                                ...
                                <td class="px-4 py-3" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" x-transition
                                        ...
                                        <div @click.away="open = false"
                                            ...
                                            <form action="{{ route('penghuni.bukti-bayar', $item->id) }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <input type="file" name="bukti_bayar" accept="image/*,.pdf"
                                                    class="block w-full text-sm mb-4 border border-gray-300 rounded px-3 py-2"
                                                    required>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-4 text-center text-gray-500">Belum ada data pembayaran.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
